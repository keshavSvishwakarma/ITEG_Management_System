...
//     switch (status) {
//       case "Selected":
//         return <span className={`${base} bg-green-100 text-green-700`}><CheckCircle className="w-4 h-4 mr-1" />Selected</span>;
//       case "Rejected":
//         return <span className={`${base} bg-red-100 text-red-700`}><XCircle className="w-4 h-4 mr-1" />Rejected</span>;
//       default:
...
//         {students.map((student) => (
//           <div key={student._id} className="bg-white rounded-xl shadow p-5 space-y-3">
//             {/* Profile */}
...
//               <p><strong>Course:</strong> {student.course}</p>
//               <p><strong>Technology:</strong> {student.techno}</p>
//               <p><strong>Gender:</strong> {student.gender}</p>
//               <p><strong>Stream:</strong> {student.stream}</p>
//             </div>
...
//             {student.interviewRecord?.length > 0 ? (
//               <div>
//                 <h3 className="text-sm font-medium text-indigo-600 mb-2">Interviews</h3>
//                 <div className="space-y-2 max-h-96 overflow-y-auto pr-1">
//                   {student.interviewRecord.map((interview) => (
//                     <div key={interview._id} className="border rounded-md p-3 bg-gray-50 shadow-sm space-y-1">
//                       <p className="text-sm"><strong>Company:</strong> {interview.companyName}</p>
//                       <p className="text-sm"><strong>Date:</strong> {new Date(interview.interviewDate).toLocaleDateString()}</p>
//                       <p className="text-sm"><strong>Location:</strong> {interview.location}</p>
//                       <p className="text-sm"><strong>Profile:</strong> {interview.jobProfile}</p>
//                       <p className="text-sm"><strong>Remark:</strong> {interview.remark || "—"}</p>
...
//               </div>
//             ) : (
//               <p className="text-sm text-red-500">No interviews found</p>
//             )}
//           </div>
//         ))}
//       </div>
...
//       {/* Update Modal */}
//       <Dialog open={isUpdateModalOpen} onClose={() => setIsUpdateModalOpen(false)} className="fixed z-50 inset-0 overflow-y-auto">
