...
//     permission: false,
//     permissionReason: "",
//     permissionDate: "", // Initialize permissionDate
//     placed: false,
//     companyName: "",
//     placementDate: "",
//     imageSrc: imageSrc,
...
//   return (
//     <div className="w-full p-4 min-h-screen bg-gray-100 font-sans">
...
//           <Form className="space-y-6 p-6 bg-white rounded-lg shadow-md mt-4">
//             {/* Save Button - Positioned top right as per UI */}
...
//                 />
//                 {/* Custom styling for SelectInput labels to match TextInput */}
//                 <div>
//                   <label
//                     htmlFor="gender"
...
//                     name="gender"
//                     options={[
//                       { value: "", label: "Gender" }, // Placeholder option
...
//                     name="track"
//                     options={[
//                       { value: "", label: "Select Track" }, // Placeholder option
...
//                 />
//                 <RadioGroup
//                   label="" // Label is empty as per UI
//                   name="courseType"
//                   options={[
...
//                 {/* Each checkbox is now rendered as a separate div within the grid to control spacing */}
//                 <CheckboxGroup
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "1A Level", label: "1A Level" }]}
...
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "1B Level", label: "1B Level" }]}
//                   checkboxClassName="form-checkbox text-orange-500"
//                   labelClassName="text-gray-700 ml-2"
//                 />
//                 <CheckboxGroup
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "1C Level", label: "1C Level" }]}
//                   checkboxClassName="form-checkbox text-orange-500"
//                   labelClassName="text-gray-700 ml-2"
//                 />
//                 <CheckboxGroup
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "2A Level", label: "2A Level" }]}
//                   checkboxClassName="form-checkbox text-orange-500"
//                   labelClassName="text-gray-700 ml-2"
//                 />
//                 <CheckboxGroup
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "2B Level", label: "2B Level" }]}
//                   checkboxClassName="form-checkbox text-orange-500"
//                   labelClassName="text-gray-700 ml-2"
//                 />
//                 <CheckboxGroup
//                   label=""
//                   name="itegLevels"
//                   options={[{ value: "2C Level", label: "2C Level" }]}
//                   checkboxClassName="form-checkbox text-orange-500"
//                   labelClassName="text-gray-700 ml-2"
//                 />
//               </div>
...
//                 Permission
//               </h2>
//               {/* This div encapsulates the label and toggle to act as one visual unit */}
//               <div className="flex justify-between items-center w-full mb-4">
//                 <label
//                   className="block text-sm font-medium text-gray-700"
//                   htmlFor="permissionSwitch"
//                 >
//                   Permission
//                 </label>
//                 {/* Custom toggle switch - UI shows a simple, smaller toggle */}
...
//                     }
//                     checked={values.permission} // Use values from Formik
//                   />
//                   {/* Visual representation of the toggle */}
...
//                 {/* "Reasons" field has a placeholder but no explicit label above it in the UI */}
//                 <TextInput
//                   label=""
//                   name="permissionReason"
//                   placeholder="Reasons"
//                 />
//                 {/* Date field also has a placeholder but no explicit label, and they seem to be part of one continuous input in UI */}
//                 <TextInput
//                   label="" // No explicit label in UI for this field
//                   name="permissionDate"
//                   placeholder="dd/mm/yyyy"
//                   type="text" // Keep as text to show placeholder clearly, if date picker is needed, change to 'date'
//                 />
//               </div>
//             </div>
...
//                     checked={values.placed} // Use values from Formik
//                   />
//                   {/* Visual representation of the toggle */}
//                   <div className="w-11 h-6 bg-gray-200 rounded-full peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-orange-300 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border after:border-gray-300 after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-500"></div>
//                 </label>
...
//                 />
//                 <TextInput
//                   label="Date of Placement" // This label is present in the UI
//                   placeholder="dd/mm/yyyy"
//                   name="placementDate"
//                   type="text" // Keep as text to show placeholder clearly
//                 />
//               </div>
//             </div>
//           </Form>
        ...
        {({ setFieldValue, values }) => (
          <Form className="space-y-6 p-6 bg-white rounded-lg shadow-md mt-4">
            ...
            <div className="border-b border-gray-300 pb-6">
              ...
              {/* This div encapsulates the label and toggle to act as one visual unit */}
              <div className="flex justify-between items-center w-full mb-4">
                {/* Label text on the left, toggle on the right */}
                <label
                  className="block text-sm font-medium text-gray-700"
                  htmlFor="permissionSwitch"
                >
