...
const allStudents = [
  {
    id: "1", // Added a unique ID for each student
    name: "Ana Sha",
    fatherName: "John Sha",
    mobile: "8123456787",
    village: "Harda",
                ...
                students
                  ...
                  .map((student, index) => (
                    <tr
                      ...
                      onClick={() => openStudentProfile(student)} // Add onClick to the row
                    >
                      ...
                      <td className="p-3 flex justify-center">
                        <img
                          ...
                          alt="edit"
                          onClick={(e) => {
                            e.stopPropagation(); // Prevent row click when edit is clicked
