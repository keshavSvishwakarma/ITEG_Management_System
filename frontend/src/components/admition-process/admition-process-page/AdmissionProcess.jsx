...
// src/pages/admission/AdmissionProcess.js — StudentList
...
//     return getLatestInterview(interviews)?.result || "";
//   };

//   const scheduleButton = (row) => {
//     console.log(getLatestInterview(row.interviews)?.marks); // For debugging
//     setShowModal(true);
//   };
...
//           label: "Marks",
//           render: (row) => {
//             const latest = getLatestInterview(row.interviews);
//             return latest?.marks ?? "N/A";
//           },
//         },
  ...
  switch (activeTab) {
    case "Online Assessment":
      columns = [
        ...
        { key: "interviewStage", label: "Status" },
      ];
      ...
      <div className="border bg-white shadow-sm rounded-lg px-5">
        <div className="flex justify-between items-center flex-wrap gap-4">
          <Pagination
            ...
            filteredData={filteredData} // pass full filtered data
          />
        </div>
